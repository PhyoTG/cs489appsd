...
public class AdventisDentistsSystemApplication implements CommandLineRunner {
	...
	public AdventisDentistsSystemApplication(AppointmentService appointmentService, AddressService addressService, DentistService dentistService, PatientService patientService, SurgeryService surgeryService, RoleRepository roleRepository) {
	...
	public void run(String... args) throws Exception {
		System.out.println("This is Persistance Layer for A Dental Service");
		...
		var role = new Role(null,"ROLE_ADMIN");
